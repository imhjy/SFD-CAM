...
class IterNet(nn.Module):
    """
    https://arxiv.org/pdf/1912.05763v1
    2018
    """
...
if __name__ == '__main__':
    ...
    print('GMAC: ', macs, 'params: ', params)  # flops:  171.35 GMac params:  13.6 M   GMAC =（乘法累加运算次数）/（10⁹）
    # Extract the numerical value
    flops = eval(re.findall(r'([\d.]+)', macs)[0]) * 2
    # Extract the unit
    flops_unit = re.findall(r'([A-Za-z]+)', macs)[0][0]
    print('GFlops: {} {}Flops'.format(flops, flops_unit))  # GFlops: 342.7 GFlops

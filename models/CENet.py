...
from models.sub_model.CENet.resnet_factory import get_resnet_backbone
...
class CENet(nn.Module):
    """
    https://arxiv.org/pdf/1903.02740v1 这篇论文建议看
    2019
    """
...
if __name__ == '__main__':
    ...
    print('GMAC: ', macs, 'params: ', params)  # flops:  109.04 GMac params:  13.39 M   GMAC =（乘法累加运算次数）/（10⁹）
    # Extract the numerical value
    flops = eval(re.findall(r'([\d.]+)', macs)[0]) * 2
    # Extract the unit
    flops_unit = re.findall(r'([A-Za-z]+)', macs)[0][0]
    print('GFlops: {} {}Flops'.format(flops, flops_unit))  # GFlops: 218.08 GFlops